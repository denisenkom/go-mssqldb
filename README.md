...
[![GoDoc](https://godoc.org/mssql?status.svg)](http://godoc.org/mssql)
 ...
 * [NewConnector](https://godoc.org/mssql#NewConnector)
    may be used with [OpenDB](https://golang.org/pkg/database/sql/#OpenDB).
 * [Connector.SessionInitSQL](https://godoc.org/mssql#Connector.SessionInitSQL)
