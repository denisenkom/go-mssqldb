...
Install with `go get github.com/lucidhq/go-mssqldb` .
 ...
 * [NewConnector](https://godoc.org/github.com/lucidhq/go-mssqldb#NewConnector)
    may be used with [OpenDB](https://golang.org/pkg/database/sql/#OpenDB).
 * [Connector.SessionInitSQL](https://godoc.org/github.com/lucidhq/go-mssqldb#Connector.SessionInitSQL)
