...
replace golang.org/x/crypto v0.0.0-20210921155107-089bfa567519 => golang.org/x/crypto v0.9.0
...
replace golang.org/x/net v0.0.0-20220906165146-f3363e06e74c => golang.org/x/net v0.10.0
