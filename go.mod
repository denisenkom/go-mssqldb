...
replace golang.org/x/net v0.0.0-20190620200207-3b0461eec859 => golang.org/x/net v0.5.0

replace golang.org/x/net v0.0.0-20210226172049-e18ecbb05110 => golang.org/x/net v0.5.0

replace golang.org/x/net v0.0.0-20220722155237-a158d28d115b => golang.org/x/net v0.5.0

replace golang.org/x/net v0.0.0-20220906165146-f3363e06e74c => golang.org/x/net v0.5.0
