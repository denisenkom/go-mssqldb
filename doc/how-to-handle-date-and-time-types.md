...
- "github.com/lucidhq/civil".Date
- "github.com/lucidhq/civil".Time
- "github.com/lucidhq/civil".DateTime
...
```
 ...
 `"github.com/lucidhq/civil".DateTime` does not have time zone information. `"github.com/lucidhq/civil".Date` only has the date information, and `"github.com/lucidhq/civil".Time` only has the time information. `string` can also be used to insert data into date and time types columns, but you have to make sure the format is accepted by SQL Server.
